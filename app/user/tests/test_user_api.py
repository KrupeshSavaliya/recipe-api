...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exist(self):
        """Testing creating user with already exist"""

        payload = {'email': 'test@gmail.com', 'password': 'abc123'}
        create_user(**payload)
    ...
    def test_password_too_sort(self):
        """Testing password must be greater then 5 char"""

        payload = {'email': 'test@gmail.com', 'password': 'abc12'}
        res = self.client.post(CREATE_USER_URL, payload)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token when invalid credentials are given"""
        create_user(email='test@gmail.com', password='abc123')
